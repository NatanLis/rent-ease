...
notifications: List[Notification] = [
    ...
    Notification(
        ...
        sender=NotificationSender(
            name='Courtney Henry',
            avatar=NotificationAvatar(src='https://i.pravatar.cc/128?u=4')
        ),
    ...
    Notification(
        ...
        sender=NotificationSender(
            name='Tom Cook',
            avatar=NotificationAvatar(src='https://i.pravatar.cc/128?u=5')
        ),
    ...
    Notification(
        ...
        sender=NotificationSender(
            name='Casey Thomas',
            avatar=NotificationAvatar(src='https://i.pravatar.cc/128?u=6')
        ),
    ...
    Notification(
        id=10,
        sender=NotificationSender(name='Drew Moore'),
        body='subscribed to your email list',
        date=sub_date(now, days=6)
    ),
    Notification(
        id=11,
        sender=NotificationSender(name='Riley Davis'),
        body='abandonned cart',
        date=sub_date(now, days=7)
    ),
    Notification(
        id=12,
    ...
    Notification(
        ...
        sender=NotificationSender(
            name='Drew Moore',
            avatar=NotificationAvatar(src='https://i.pravatar.cc/128?u=16')
        ),
        body='subscribed to your email list',
    ...
    Notification(
        ...
        sender=NotificationSender(name='Drew Moore'),
        body='subscribed to your email list',
        date=sub_date(now, days=18)
    ),
    Notification(
        id=23,
        sender=NotificationSender(name='Riley Davis'),
        body='subscribed to your email list',
        date=sub_date(now, days=19)
    ),
    Notification(
        id=24,
        sender=NotificationSender(
            name='Jordan Taylor',
            avatar=NotificationAvatar(src='https://i.pravatar.cc/128?u=24')
        ),
        body='subscribed to your email list',
